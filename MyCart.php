...
$id=date('Ymdhis');
        ...
        foreach ($array as $key => $value){
					$insert = mysqli_query($con,"INSERT INTO orders (invoice_no,c_id,p_id,v_email,qty) values ('$id','$value[0]','$value[1]','$value[2]','$value[4]')");
				}
				$del=mysqli_query($con,"DELETE FROM cart where cart.c_id='".$data['c_id']."'");
