...
<body class="dark-edition">
  <div class="wrapper ">
    <div class="sidebar" data-color="purple" data-background-color="black" data-image="./image/wall.jpg">
      <!--
      ...
      <div class="sidebar-wrapper ps-container ps-theme-default" data-ps-id="3a8db1f4-24d8-4dbf-85c9-4f5215c1b29a">
        <ul class="nav">
          ...
          <li class="nav-item ">
           ...
           <li class="nav-item">
            <a class="nav-link" href="managearea.php">
              <p>Add Area</p>
            </a>
            </li>
            <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
            <a class="nav-link" href="ffedback.php">
              <p>Users Feedback</p>
            </a>
            </li>
