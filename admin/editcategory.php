...
$result=mysqli_query($con,"SELECT cat_id,cat_title from category where cat_id='$cat_id'")or die ("query 1 incorrect.......");
...
mysqli_query($con,"UPDATE category set cat_title='$cat_title' where cat_id='$cat_id'")or die("Query 2 is inncorrect..........");

header("location: managecategroy.php");
mysqli_close($con);
}
?>
      <!-- End Navbar -->
