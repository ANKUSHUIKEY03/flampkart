          ...
          <div class="col-lg-8">
            ...
            <?php
                ...
                if(isset($_POST['login'])){
                	...
                	$query = mysqli_query($con,"SELECT * from customer where c_email ='$email' AND c_pass ='$password'");
          ...
          <?php
             ...
             <div class="card shadow-sm mt-3" style="width:100%">
               ...
               <?php
                   ...
                   $query=mysqli_query($con,"SELECT * FROM product INNER JOIN vendor ON
                    product.v_email=vendor.v_email WHERE p_id='$p_id'");
             ...
             <?php
                  if(isset($_POST['chng_add'])){
                    ...
                    $update=mysqli_query($con,"UPDATE customer
                    SET
                 ...
                 $id=date('Ymdhis');
                   if(isset($_POST['order'])){
                     ...
                     $insert = mysqli_query($con,"INSERT INTO orders (invoice_no,c_id,p_id,v_email,qty) values ('$id','$c_id','$p_id','$v_email','$qty')");
                           ...
                           <div class="card shadow">
                             ...
                             <div class="card-body">
                               <table style="width:100%">
                                 ...
                                 <?php
                                 $id=$_GET['p_id'];
                                 $p=mysqli_query($con,"SELECT * from product where p_id='$id'");
